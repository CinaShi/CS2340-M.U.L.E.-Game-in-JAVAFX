 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Wenzhong Jin");
		  toPrint += p1.toString("903048854");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Mengyang Shi");
		  toPrint += p2.toString("903057298");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jihai An");
		  toPrint += p3.toString("903056575");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Yichen Li");
                  toPrint += p4.toString("903074658");
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Congyao Zheng");
                  toPrint += p5.toString("903154819");
